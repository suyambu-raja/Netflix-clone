import backgroundImg from "../../assets/netflix_background.jpg";
...
const SignInPage = () => {
  const { authc, setAuthc } = useContext(DataContext)
  ...
  return (
    ...
    >
      ...
      <div className="signIn-container" style={{ display: authc ? "block" : "none" }}>
        ...
        <form className="input-container-for-signIn">
          ...
          <button className="signIn-btn" onClick={user_auth} type="submit">Sign In</button>
        </form>
      ...
      <div className="signUp-container signIn-container" style={{ display: !authc ? "block" : "none" }}>
        ...
        <form className="input-container-for-signIn">
          ...
          <button className="signIn-btn" onClick={user_auth} type="submit">Sign Up</button>
        </form>
        <div className="footer-section-for-signIn">
          <div className="need-help-container">
            <div className="checkbox-container">
